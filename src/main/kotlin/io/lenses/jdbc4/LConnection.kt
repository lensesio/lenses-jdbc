...
import io.lenses.jdbc4.statements.InsertPreparedStatement
import io.lenses.jdbc4.statements.LStatement
import io.lenses.jdbc4.statements.SelectPreparedStatement
...
class LConnection(private val uri: String,
  ...
  private val urls = uri.replace(io.lenses.jdbc4.Constants.JdbcPrefix, "").split(',').apply {
    if (this.isEmpty())
