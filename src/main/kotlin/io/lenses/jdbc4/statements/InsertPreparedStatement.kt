...
class InsertPreparedStatement(private val conn: Connection,
  ...
  private var builder = io.lenses.jdbc4.RecordBuilder(info)
  ...
  override fun clearParameters() {
    builder = io.lenses.jdbc4.RecordBuilder(info)
  }
  ...
  override fun getParameterMetaData(): ParameterMetaData = io.lenses.jdbc4.AvroSchemaParameterMetaData(info)
  ...
  override fun addBatch() {
    builder.checkRecord()
    if (batch.size == io.lenses.jdbc4.Constants.BATCH_HARD_LIMIT)
      throw SQLException("Batch size would exceed maximum of ${io.lenses.jdbc4.Constants.BATCH_HARD_LIMIT}")
