  ...
  init {
    ...
    "RecordBuilder.checkBounds" should {
      ...
      "build flat json structure" {
        ...
        io.lenses.jdbc4.JacksonSupport.mapper.writeValueAsString(node) shouldBe """{"a":"woo","b":"foo"}"""
      }
      "build nested json structure" {
        ...
        val (key, node) = builder.build()
        key.asText() shouldBe "wibble"
        io.lenses.jdbc4.JacksonSupport.mapper.writeValueAsString(node) shouldBe """{"a":"woo","b":{"c":"foo"}}"""
      }
    }
  }
}